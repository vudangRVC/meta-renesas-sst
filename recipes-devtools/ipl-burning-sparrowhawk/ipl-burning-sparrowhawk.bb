DESCRIPTION = "IPL burning tool for Sparrow-Hawk (V4H), built alongside rz-cmn"
...
SRC_URI:append = " \
    ...
    ${PCIE_FIRMWARE} \
    ${PCIE_FIRMWARE_LIC} \
    https://www.python.org/ftp/python/3.13.4/python-3.13.4-embed-amd64.zip;name=pyembed;unpack=0 \
    https://bootstrap.pypa.io/get-pip.py;name=getpip \
"

SRC_URI[pyembed.sha256sum] = "514ca14ec356ecb7749a7c0a1ef1eac9fd9c67d57af4812cb1f0822b0d3a85e8"
SRC_URI[getpip.sha256sum] = "a341e1a43e38001c551a1508a73ff23636a11970b61d901d9a1cad2a18f57055"
