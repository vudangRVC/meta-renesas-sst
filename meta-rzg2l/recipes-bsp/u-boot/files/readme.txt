...
You can modify it on Linux Userland (at /boot directory) to match your U-Boot environment.
To load the devicetree overlay file from "overlay/" folder, you should set "enable_overlay_". 
