...
│   └── Readme.md
├── rzpi--6.10.14+git0+af06ad75b8_bbe3d1be4e-r0-rzg2l-sbc-20241213061340.dtbo  <---- Main device tree blob file for RZ/G2L-SBC
└── rzpi.dtb -> rzpi--6.10.14+git0+af06ad75b8_bbe3d1be4e-r0-rzg2l-sbc-20241213061340.dtbo  <---- Symlink to the main dtb file
