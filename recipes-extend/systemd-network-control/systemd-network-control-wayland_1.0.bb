...
do_install() {
    ...
    install -m 0755 ${S}/quickboot-wayland/disable_networking_stack.sh ${D}/home/root/network-management
    install -m 0755 ${S}/quickboot-wayland/enable_networking_stack.sh ${D}/home/root/network-management
}
