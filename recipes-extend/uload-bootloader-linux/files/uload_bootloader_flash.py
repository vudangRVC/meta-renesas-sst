...
class FlashUtil:
	...
	def __writeBootloader(self):
		...
		# loading bl2...
		self.__serialPort.write('fatload mmc 0:1 0x48000000 uload-bootloader/bl2_bp-rzg2l-sbc.bin \r'.encode())
		...
		# loading fip...
		self.__serialPort.write('fatload mmc 0:1 0x48000000 uload-bootloader/fip-rzg2l-sbc.bin \r'.encode())
		buf = self.__serialPort.read_until('MiB/s)'.encode())
		if not buf:
			print("Returned value is not the expectation. Exiting.")
			exit()
