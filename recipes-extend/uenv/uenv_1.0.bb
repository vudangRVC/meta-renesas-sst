...
do_deploy () {
    ...
    # Install to boot folder in deploydir, prepare for install to partition 1
    install -d ${DEPLOYDIR}/boot
    install -m 0644 ${D}/boot/Readme.md ${DEPLOYDIR}/boot
    install -m 0644 ${D}/boot/uEnv.txt ${DEPLOYDIR}/boot
}
