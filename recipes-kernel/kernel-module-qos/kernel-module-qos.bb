...
SRCREV = "72a861aab57e0529b0f24ea2febdaa7afce52fda"
SRC_URI:append = " file://0001-Fix-build-error-with-new-kernel.patch"
...
# Load qos.ko automatically at boot
KERNEL_MODULE_AUTOLOAD += "qos"

# WARN()/__FILE__ strings in qos.ko carry the kernel-source path from
# work-shared; they are inert but trip the buildpaths QA scan
