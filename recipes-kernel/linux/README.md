...
|--------------|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| rzg2l-sbc/   | Due the use of machine conf in the SRC_URI (i.e SRC_URI:append:<machine>): the fetcher looks for the cfg files in the <machine> (multi-boards) directory instead of <recipe_name> (i.e linux-yocto).|
