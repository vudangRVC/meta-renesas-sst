...
# meson's build_rpath (set to the source dir in src/meson.build) is stripped
# at install time but leaves a stale, unreferenced path string in .dynstr,
# which trips the buildpaths QA scan
